<template>
  <div>
    ...
    <div class="h-screen flex">
      <div
        class="flex w-1/2 bg-gradient-to-tr from-primary to-secondary justify-around items-center"
      >
        <div>
          <h1 class="text-white font-bold text-4xl font-sans">Bookko</h1>
          <p class="text-white mt-1">
            The most popular online book store at SEA
          </p>
          <button
            type="submit"
      ...
      <div class="flex w-1/2 justify-center items-center bg-white">
        <form class="bg-white" @submit.prevent="">
          ...
          <span class="text-sm ml-2 hover:text-blue-500 cursor-pointer" @click="currentStep = 2"
          ...
          <p class="text-sm font-normal text-gray-600 mb-7">Create a new account</p>
          <div class="flex items-center border-2 py-2 px-3 rounded-2xl mb-4">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              class="h-5 w-5 text-gray-400"
