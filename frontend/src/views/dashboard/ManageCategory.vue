<template>
  <div class="flex h-full font-ibmp">
    <div class="fixed lg:static bottom-0 w-full lg:w-24 lg:h-full z-10">
      <div class="w-full lg:fixed lg:w-24 h-full bg-primary-dark relative">
        <router-link
          to="/"
        ...
        >
          <div class="text-white text-2xl font-bold">BK</div>
        </router-link>
...
import Tools from "@/components/dashboard/Tools.vue";
// import Blog from '@/components/dashboard/Blog.vue'
// import Candlesticks from '@/components/dashboard/Candlesticks.vue'
import CategoryTable from "@/components/dashboard/CategoryTable.vue";
