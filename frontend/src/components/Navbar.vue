<template>
  <div class="bg-black">
    ...
    >
      ...
      >
        <!-- <li
          class="text-gray-100 hover:text-red-300 cursor-pointer"
          @click="enableSave"
        >
          <svg
        ...
        <li class="text-gray-100 hover:text-red-300">
        ...
        <li>
          <router-link to="/cart">
            <svg
              ...
              height="24"
              viewBox="0 0 24 24"
              class="fill-red-600 cursor-pointer -ml-2"
            >
              <path
